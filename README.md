...
108 comprehensive cloud platform skills for AI coding agents. Each skill is a standalone `SKILL.md` file that any AI coding assistant with skills support can use — including [GitHub Copilot](https://docs.github.com/en/copilot), [Claude Code](https://docs.anthropic.com/en/docs/claude-code), [JaaiCode](https://github.com/tomz/jaaicode), and other agents that follow the SKILL.md convention.
...
| `azure-fabric-rayfin` | Microsoft Rayfin — open-source Backend-as-a-Service on Fabric; TypeScript-decorator data models provision DB, auth, GraphQL/REST APIs, storage, and static hosting |
